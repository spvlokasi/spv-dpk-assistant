...
export const LoginPage: React.FC<LoginPageProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen w-full bg-slate-50 flex font-sans">
      {/* =========================================================
          SISI KIRI: Foto Toko Asli (login-bg.jpg) Murni Tanpa Tulisan
          - Di Desktop (PC): Mengambil 65% Lebar Layar
          - Di Mobile (Android): Disembunyikan Total (hidden lg:block)
          ========================================================= */}
      <div className="hidden lg:block lg:w-[65%] h-screen overflow-hidden bg-slate-200 flex-shrink-0 relative">
        <img
          src="/login-bg.jpg"
      ...
      {/* =========================================================
          SISI KANAN: Form Login Asli Toko Basmalah
          - Di Desktop (PC): Mengambil 35% Lebar Layar
          - Di Mobile (Android): Mengambil 100% Layar Penuh (Tanpa Foto)
          ========================================================= */}
      <div className="w-full lg:w-[35%] flex-1 min-h-screen flex flex-col justify-center items-center p-6 sm:p-10 lg:p-10 bg-slate-50 relative z-10">
        <div className="w-full max-w-sm space-y-6">
          {/* Logo & Judul Toko Basmalah */}
