        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-slate-800">
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 text-[11px] font-medium flex items-center gap-1.5 border border-slate-700 transition-colors"
            >
