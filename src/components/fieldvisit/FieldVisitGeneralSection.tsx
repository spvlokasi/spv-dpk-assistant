    ...
    <div className="space-y-3.5 text-xs">
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        <div>
          ...
          <select
            ...
            onChange={(e) => onFormChange({ branchId: e.target.value })}
      ...
      <div>
        ...
        <input
          ...
          placeholder="Contoh: Audit Display & Kebersihan / Coaching KTB Target Harian"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <label className="block text-slate-400 mb-1 font-semibold">Materi Coaching Kepala Toko (KTB):</label>
          <textarea
            rows={2}
            value={formData.katokCoachingTopic}
            onChange={(e) => onFormChange({ katokCoachingTopic: e.target.value })}
            placeholder="Hal penting yang dibahas bersama KTB..."
            className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-emerald-500"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            onChange={(e) => onFormChange({ katokCommitment: e.target.value })}
            placeholder="Janji perbaikan konkret dari KTB..."
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            onChange={(e) => onFormChange({ crewCoachingTopic: e.target.value })}
            placeholder="Contoh: Penawaran produk kasir & sapa pelanggan"
            className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-emerald-500"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) => onFormChange({ summaryConclusion: e.target.value })}
            placeholder="Contoh: Toko membaik, display rapi, KTB berkomitmen kejar target"
            className="w-full bg-slate-800 border border-slate-700 rounded-xl px-3 py-2 text-slate-200 focus:outline-none focus:border-emerald-500"
          />
        </div>
      </div>
