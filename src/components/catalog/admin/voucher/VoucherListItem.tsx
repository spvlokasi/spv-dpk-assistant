...
export const VoucherListItem: React.FC<VoucherListItemProps> = ({
  voucher: v, onToggleStatus, onDelete
}) => {
      ...
      <div className="space-y-2">
        ...
        <div className="bg-slate-800/80 p-2 rounded-xl border border-slate-700/60 space-y-1">
          <div className="flex items-center justify-between text-[10px]">
            <span className="text-slate-400 font-semibold flex items-center gap-1"><Users className="w-3 h-3 text-emerald-400" />Sisa Kuota:</span>
            <span className="font-mono font-bold text-emerald-400">{remaining} / {totalQuota} Kupon</span>
          </div>
