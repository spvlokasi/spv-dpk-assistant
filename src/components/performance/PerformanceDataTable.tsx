            ...
            {branchPerf.map((p) => {
              ...
              return (
                <tr key={p.id} className="hover:bg-slate-850/60 transition-colors">
                  ...
                  <td className={`p-3 text-right font-mono font-bold ${isHit ? 'text-emerald-400' : 'text-rose-400'}`}>
                    {formatRupiah(p.salesActual)}
                  </td>
                  ...
                  <td className="p-3 text-center">
                    <button
                      ...
                      className="p-1 rounded-lg text-rose-400 hover:bg-rose-950/40 transition-colors"
                      title="Hapus Data"
                    >
